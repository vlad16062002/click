 ...
 */
export declare type AppearanceSchemeType = 'client_light' | 'client_dark' | 'space_gray' | 'bright_light';
/**
 ...
 * Update config data
 */
export declare type UpdateConfigData = DefaultUpdateConfigData | MVKUpdateConfigData | VKUpdateConfigData;
